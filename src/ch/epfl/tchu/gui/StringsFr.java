...
public final class StringsFr {
    ...
    public static final String WINS =
            "\nVous remportez la victoire avec %s point%s, contre %s point%s !\n";
    public static final String LOSES =
            "\n Vous perdez la partie avec %s point%s, contre %s point%s !\n";
    public static final String DRAW =
            "\nVous êtes ex æqo avec %s points !\n";
